...
to {
  ...
  animation: ${et} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,$=({toast:e})=>{let{icon:c,type:d,iconTheme:f}=e;return void 0!==c?"string"==typeof c?h.createElement(er,null,c):c:"blank"===d?null:h.createElement(ee,null,h.createElement(W,{...f}),"loading"!==d&&h.createElement(X,null,"error"===d?h.createElement(B,{...f}):h.createElement(K,{...f})))},Re=e=>`
...
`,ke=(e,c)=>{let d=e.includes("top")?1:-1,[f,g]=E()?["0%{opacity:0;} 100%{opacity:1;}","0%{opacity:1;} 100%{opacity:0;}"]:[Re(d),Ee(d)];return{animation:c?`${O(f)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${O(g)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}},en=h.memo(({toast:e,position:c,style:d,children:f})=>{let g=e.height?ke(e.position||c||"top-center",e.visible):{opacity:0},y=h.createElement($,{toast:e}),b=h.createElement(ei,{...e.ariaProps},dist_h(e.message,e));return h.createElement(ea,{className:e.className,style:{...g,...d,...e.style}},"function"==typeof f?f({icon:y,message:b}):h.createElement(h.Fragment,null,y,b))});m(h.createElement);var we=({id:e,className:c,style:d,onHeightUpdate:f,children:g})=>{let y=h.useCallback(c=>{if(c){let l=()=>{f(e,c.getBoundingClientRect().height)};l(),new MutationObserver(l).observe(c,{subtree:!0,childList:!0,characterData:!0})}},[e,f]);return h.createElement("div",{ref:y,className:c,style:d},g)},Me=(e,c)=>{let d=e.includes("top"),f=e.includes("center")?{justifyContent:"center"}:e.includes("right")?{justifyContent:"flex-end"}:{};return{left:0,right:0,display:"flex",position:"absolute",transition:E()?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${c*(d?1:-1)}px)`,...d?{top:0}:{bottom:0},...f}},eo=u`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
`,Fe=({reverseOrder:e,position:c="top-center",toastOptions:d,gutter:f,children:g,toasterId:y,containerStyle:b,containerClassName:v})=>{let{toasts:x,handlers:C}=dist_w(d,y);return h.createElement("div",{"data-rht-toaster":y||"",style:{position:"fixed",zIndex:9999,top:16,left:16,right:16,bottom:16,pointerEvents:"none",...b},className:v,onMouseEnter:C.startPause,onMouseLeave:C.endPause},x.map(d=>{let y=d.position||c,b=Me(y,C.calculateOffset(d,{reverseOrder:e,gutter:f,defaultPosition:c}));return h.createElement(we,{id:d.id,key:d.id,onHeightUpdate:C.updateHeight,className:d.visible?eo:"",style:b},"custom"===d.type?dist_h(d.message,d):g?g(d):h.createElement(en,{toast:d,position:y}))}))},es=dist_n}},function(e){e.O(0,[535,971,184,744],function(){return e(e.s=1259)}),_N_E=e.O()}]);