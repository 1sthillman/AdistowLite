"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[609],{4471:function(e,t,r){r.d(t,{Bt:function(){return serverTimestamp},EK:function(){return Timestamp},ET:function(){return addDoc},IO:function(){return query},JU:function(){return doc},PL:function(){return getDocs},ad:function(){return getFirestore},ar:function(){return where},b9:function(){return limit},cf:function(){return onSnapshot},hJ:function(){return collection},nP:function(){return increment},pl:function(){return setDoc},r7:function(){return updateDoc},vr:function(){return arrayUnion}});var n,i,s,a,o=r(3304),l=r(3576),u=r(8650),c=r(4534),_=r(3172),h=r(4203);r(2601);var d=r(263).Buffer;let m="@firebase/firestore",f="4.9.3";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let W="RestConnection",j={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};let __PRIVATE_RestConnection=class __PRIVATE_RestConnection{get $o(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;let t=e.ssl?"https":"http",r=encodeURIComponent(this.databaseId.projectId),n=encodeURIComponent(this.databaseId.database);this.Uo=t+"://"+e.host,this.Ko=`projects/${r}/databases/${n}`,this.Wo=this.databaseId.database===v?`project_id=${r}`:`project_id=${r}&database_id=${n}`}Go(e,t,r,n,i){let s=__PRIVATE_generateUniqueDebugId(),a=this.zo(e,t.toUriEncodedString());__PRIVATE_logDebug(W,`Sending RPC '${e}' ${s}:`,a,r);let o={"google-cloud-resource-prefix":this.Ko,"x-goog-request-params":this.Wo};this.jo(o,n,i);let{host:l}=new URL(a),u=(0,c.Xx)(l);return this.Jo(e,a,o,r,u).then(t=>(__PRIVATE_logDebug(W,`Received RPC '${e}' ${s}: `,t),t),t=>{throw __PRIVATE_logWarn(W,`RPC '${e}' ${s} failed with error: `,t,"url: ",a,"request:",r),t})}Ho(e,t,r,n,i,s){return this.Go(e,t,r,n,i)}jo(e,t,r){e["X-Goog-Api-Client"]="gl-js/ fire/"+p,e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((t,r)=>e[r]=t),r&&r.headers.forEach((t,r)=>e[r]=t)}zo(e,t){let r=j[e];return`${this.Uo}/v1/${t}:${r}`}terminate(){}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
