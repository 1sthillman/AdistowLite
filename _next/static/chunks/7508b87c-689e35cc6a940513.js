"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[609],{4471:function(e,t,r){r.d(t,{Bt:function(){return serverTimestamp},EK:function(){return Timestamp},ET:function(){return addDoc},JU:function(){return doc},ad:function(){return getFirestore},cf:function(){return onSnapshot},hJ:function(){return collection},nP:function(){return increment},pl:function(){return setDoc},r7:function(){return updateDoc},vr:function(){return arrayUnion}});var n,i,s,a,o=r(3304),l=r(3576),u=r(8650),c=r(4534),_=r(3172),h=r(4203);r(2601);var d=r(263).Buffer;let m="@firebase/firestore",f="4.9.3";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let p="12.7.0",T=new u.Yd("@firebase/firestore");function __PRIVATE_getLogLevel(){return T.logLevel}function __PRIVATE_logDebug(e,...t){if(T.logLevel<=u.in.DEBUG){let r=t.map(__PRIVATE_argToString);T.debug(`Firestore (${p}): ${e}`,...r)}}function __PRIVATE_logError(e,...t){if(T.logLevel<=u.in.ERROR){let r=t.map(__PRIVATE_argToString);T.error(`Firestore (${p}): ${e}`,...r)}}function __PRIVATE_logWarn(e,...t){if(T.logLevel<=u.in.WARN){let r=t.map(__PRIVATE_argToString);T.warn(`Firestore (${p}): ${e}`,...r)}}function __PRIVATE_argToString(e){if("string"==typeof e)return e;try{/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let N=new SortedMap(DocumentKey.comparator),F=new SortedMap(DocumentKey.comparator);function documentMap(...e){let t=F;for(let r of e)t=t.insert(r.key,r);return t}function __PRIVATE_convertOverlayedDocumentMapToDocumentMap(e){let t=F;return e.forEach((e,r)=>t=t.insert(e,r.overlayedDocument)),t}function __PRIVATE_newDocumentKeyMap(){return new ObjectMap(e=>e.toString(),(e,t)=>e.isEqual(t))}let k=new SortedMap(DocumentKey.comparator),M=new SortedSet(DocumentKey.comparator);function __PRIVATE_documentKeySet(...e){let t=M;for(let r of e)t=t.add(r);return t}let L=new SortedSet(__PRIVATE_primitiveComparator);function __PRIVATE_targetIdSet(){return L}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ExistenceFilter=class ExistenceFilter{constructor(e,t){this.count=e,this.unchangedNames=t}};function __PRIVATE_isPermanentError(e){switch(e){case E.OK:return fail(64938);case E.CANCELLED:case E.UNKNOWN:case E.DEADLINE_EXCEEDED:case E.RESOURCE_EXHAUSTED:case E.INTERNAL:case E.UNAVAILABLE:case E.UNAUTHENTICATED:return!1;case E.INVALID_ARGUMENT:case E.NOT_FOUND:case E.ALREADY_EXISTS:case E.PERMISSION_DENIED:case E.FAILED_PRECONDITION:case E.ABORTED:case E.OUT_OF_RANGE:case E.UNIMPLEMENTED:case E.DATA_LOSS:return!0;default:return fail(15467,{code:e})}}function __PRIVATE_mapCodeFromRpcCode(e){if(void 0===e)return __PRIVATE_logError("GRPC error has no .code"),E.UNKNOWN;switch(e){case n.OK:return E.OK;case n.CANCELLED:return E.CANCELLED;case n.UNKNOWN:return E.UNKNOWN;case n.DEADLINE_EXCEEDED:return E.DEADLINE_EXCEEDED;case n.RESOURCE_EXHAUSTED:return E.RESOURCE_EXHAUSTED;case n.INTERNAL:return E.INTERNAL;case n.UNAVAILABLE:return E.UNAVAILABLE;case n.UNAUTHENTICATED:return E.UNAUTHENTICATED;case n.INVALID_ARGUMENT:return E.INVALID_ARGUMENT;case n.NOT_FOUND:return E.NOT_FOUND;case n.ALREADY_EXISTS:return E.ALREADY_EXISTS;case n.PERMISSION_DENIED:return E.PERMISSION_DENIED;case n.FAILED_PRECONDITION:return E.FAILED_PRECONDITION;case n.ABORTED:return E.ABORTED;case n.OUT_OF_RANGE:return E.OUT_OF_RANGE;case n.UNIMPLEMENTED:return E.UNIMPLEMENTED;case n.DATA_LOSS:return E.DATA_LOSS;default:return fail(39323,{code:e})}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
